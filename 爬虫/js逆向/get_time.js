...
var LunMon=new Array("正","二","三","四","五","六","七","八","九","十","冬","腊");
...
function weekday(){ 
      var day = new Array("星期日","星期一","星期二","星期三","星期四","星期五","星期六","星期日");
...
function a(){
	...
	console.log(lDObj.dayCyl)
	var s = cyclical(lDObj.monCyl)+'月'+cyclical(44064)+'日' ;
	console.log(s)
